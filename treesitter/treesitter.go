...
// else-if mis-parse. Every supported language currently has a cognitive spec, so
// Cognitive is always populated; the type still allows nil (with Cyclomatic
// reported) should a future language ship without one.
package treesitter
